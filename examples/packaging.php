 ...
 *
 * To create the corresponding package, simply run this from the project root:
 * bin/packager lib/monthly_income.csv examples/packaging.php
 *
 * @package Coseva
 * @subpackage Examples
 */

// Coseva will be automatically required by the created package.
use \Coseva\Csv;
